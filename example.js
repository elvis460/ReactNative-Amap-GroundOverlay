  ...
  render() {
    ...
    return (
      <View style={styles.container}>
            <AMapView onPress={(e)=>console.log("Map::onPress", e.nativeEvent)} onLongPress={()=>console.log(arguments)} ref="map" initialRegion={{latitude:23.058139, longitude:113.390862}} apiKey="745df7975b10c8b48e9e93015f37b2ad"
                showsUserLocation={true} showsCompass={true} zoomEnabled={true}  showsScale={true} showsTraffic={true} >
                <AMapView.Marker pinColor="green" draggable onDragEnd={this._hanleMarkeDragEnd} title={this.state.title} description="这是一个好地方" coordinate={{latitude:23.058139, longitude:113.390862}} />
            </AMapView>
      </View>
    );
  }
